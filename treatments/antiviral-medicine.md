...
면역억제 환자, 안부·이성 대상포진, 파종성 대상포진, 신부전 환자 등은 용량·경로 조정이 필요하며, 정맥 acyclovir가 검토되는 경우도 있습니다 — 의료진과 함께 결정합니다[^1].
...
### 주의 환자군
- **신기능 저하 환자** — 약물이 신장으로 배설되므로 **용량 조정 필수**, 미조정 시 신경 독성(혼란·환각·경련) 위험. 고령에서 특히 주의[^1]
...
관련 entity:
- 진단·전체 치료 흐름: [zoster](../conditions/zoster.md)
- PHN: [postherpetic-neuralgia](../conditions/postherpetic-neuralgia.md)
- 신경차단술(통증 조절·PHN 예방): [nerve-block-injection](./nerve-block-injection.md)
