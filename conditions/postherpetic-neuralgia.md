...
PHN은 단순한 “대상포진 후유증”이 아니라, **급성 대상포진 진단 직후부터 만성 신경통 위험을 줄이기 위해 관리해야 하는 질환**입니다. ① 72시간 내 항바이러스, ② 급성기 통증 강도 조절, ③ 고위험군의 신경차단 조기 검토, ④ 3개월 이상 지속 통증의 만성 PHN 관리를 하나의 연속선으로 봅니다.
...
PHN으로 진행한 환자에서도 다학제 통증 관리로 의미 있는 회복이 가능하므로, 만성기에도 통증의학과 평가가 권장됩니다. 환자 안내 문구는 “피부는 나았는데 통증이 남은 이상한 상태”가 아니라, **신경 손상과 감작이 남은 치료 가능한 만성 통증 상태**로 설명하는 편이 진료 진료 흐름을 설명하기 쉽습니다.
