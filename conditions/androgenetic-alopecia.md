...
title: 안드로겐성 탈모 (남성형·여성형)
description: 안드로겐 호르몬·유전 요인에 의한 진행성 탈모
title_en: androgenetic alopecia (AGA)
aliases:
  - 남성형 탈모
  - 여성형 탈모
...
- **엑소좀 두피 주사** — 11 임상 연구에서 모발 밀도 9.5~35 hairs/cm² 증가가 보고되었으며, 표준화·대규모 RCT가 누적되는 단계입니다[^6] → [exosome-therapy](../treatments/exosome-therapy.md)
