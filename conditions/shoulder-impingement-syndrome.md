...
---
## 정의
충돌 증후군(shoulder impingement syndrome, subacromial impingement syndrome)은 팔을 들어 올릴 때 회전근개 힘줄 또는 활액낭이 견봉 아래 좁은 공간에서 자극을 받아 통증을 일으킨다고 알려진 상태입니다 [^1]. 다만 최근에는 단순 구조적 충돌 모델만으로 어깨 통증을 설명하기 어렵다는 evidence가 누적되어, 일부 가이드라인은 충돌 증후군과 회전근개 건병증을 **회전근개 관련 어깨 통증(rotator cuff related shoulder pain, RCRSP)** 이라는 우산 범주로 다루는 접근을 제시합니다 [^2].
