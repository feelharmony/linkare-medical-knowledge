...
### 척골신경 동반 평가
척골신경은 내측상과 바로 뒤쪽의 좁은 골 통로(큐비탈 터널)를 지나갑니다. 내측상과염 환자의 일부는 팔꿈치 통증 외에 **새끼손가락·약지의 저림, 감각 둔화, 미세한 근력 저하**를 함께 호소합니다 [^3]. 이 동반 증상의 유무가 치료 계획을 가릅니다 — 힘줄만 다룰지, 신경 압박까지 해소해야 할지 결정하는 갈림길이기 때문입니다.
...
- **척골신경병증(큐비탈 터널 증후군)** — 새끼손가락·약지의 저림, 손의 미세 동작 감소가 주증상. 신경 전도 검사와 Tinel 징후로 평가 [^3]
