...
## 치료 옵션
외측·내측 상과염을 비롯한 비외상성 팔꿈치 통증의 치료는 **보존적 접근이 원칙**이며, 활동 조절·운동치료·환자 교육이 1차 권고입니다. 통증이 지속되거나 재활 진입이 어려운 경우에는 [윈백 고주파(TECAR/RF) 물리치료](/treatments/tecar-rf-therapy/)와 [체외충격파](/treatments/eswt/)(ESWT)를 통증 조절·힘줄 회복 환경 보조로 병행할 수 있습니다.
...
- **바깥쪽 힘줄 통증**: 활동 조절, 손목 신전근 부하 조절, 편심성/등척성 운동, 도수치료를 기본으로 둡니다 [^3]. 통증이 강해 운동 진입이 어렵거나 만성화되면 [윈백 고주파](/treatments/tecar-rf-therapy/)·ESWT를 보조로 검토하고, 스테로이드 반복을 줄이고 싶은 3개월 이상 지속 상과염에서는 PRP/PRF 자가활성화세포 재생주사를 논의할 수 있습니다 [^4][^5].
